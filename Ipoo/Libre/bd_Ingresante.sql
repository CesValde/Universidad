    ...
    CREATE TABLE modulo (
        midentificacion int AUTO_INCREMENT,
        ...
        FOREIGN KEY(aidentificacion) REFERENCES actividad (aidentificacion)
    ) ENGINE=InnoDB DEFAULT CHARSET=utf8 AUTO_INCREMENT=1;
    ...
    CREATE TABLE inscripcion (
        ...
        FOREIGN KEY(midentificacion) REFERENCES modulo (midentificacion),
